...
const createAgent_1 = require("./createAgent");
// If AgentPlatform and AIAgent are defined in this file, remove this import and ensure their definitions are present below.
...
app.post("/start-ai-agent", async (req, res) => {
    ...
    try {
        ...
        if (!aiAgentCache.has(user_id) && !pendingAiAgents.has(user_id)) {
            ...
            const agent = await (0, createAgent_1.createAgent)(user_id, AgentPlatform.OPENAI, channel_type, channel_id);
            await agent.init();
